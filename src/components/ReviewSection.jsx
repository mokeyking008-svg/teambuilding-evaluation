...
function Avatar({ src, name, size = 'w-8 h-8' }) {
  ...
  return error || !src ? (
    <div className={`${size} rounded-full bg-primary flex items-center justify-center flex-shrink-0`}>
    ...
    <div className="space-y-4">
      ...
      {!submitted ? (
        <div className="card p-4">
          <h3 className="text-sm font-bold text-text-primary mb-3 flex items-center gap-1.5">
            <MessageSquare className="w-3.5 h-3.5 text-primary" /> 写点评
          </h3>
          <textarea
            value={reviewText}
          ...
          <button
            ...
            className="mt-3 w-full py-2.5 btn-primary text-sm font-bold rounded-lg"
          >
            提交点评
          </button>
        </div>
        ...
        <div className="card p-4 border border-primary/20">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-bold text-text-primary flex items-center gap-1.5">
              <PenLine className="w-3.5 h-3.5 text-primary" /> 我的点评
            </h3>
            <button
      ...
      {reviews.length > 0 && (
        <div className="space-y-2">
          <h3 className="text-sm font-bold text-text-primary flex items-center gap-1.5">
            <Users className="w-3.5 h-3.5 text-primary" /> 全部点评
          </h3>
