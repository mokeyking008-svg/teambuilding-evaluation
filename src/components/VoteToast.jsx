  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ transitionDuration: '400ms' }}
      >
      <div className="bg-white rounded-xl px-5 py-4 shadow-lg min-w-[280px] max-w-[360px]">
        {/* 主标题 */}
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-sm font-bold text-text-primary">
            已为「{toast.planName}」投票 <span className="text-primary">&#10003;</span>
          </span>
        </div>
        ...
        <div className="mt-2.5 ml-9 flex items-center gap-1.5">
          <div className="flex items-center gap-1 bg-[#E8FFF0] rounded-full px-2.5 py-1">
